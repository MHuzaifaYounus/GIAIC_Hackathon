...
function generateResume(inputData) {
    ...
    document.getElementsByClassName("User_Email")[0].innerHTML = `<img class="icon" src="/src/assets/icons/web.svg" alt="icon not found"> <a  target="_blank"
    href="${inputData.contact.email}">${inputData.contact.email}</a>`;
    document.getElementsByClassName("User_Website")[0].innerHTML = `<img class="icon" src="/src/assets/icons/web.svg" alt="icon not found"> <a  target="_blank"
    href="${inputData.contact.website}">${inputData.contact.website}</a>`;
    document.getElementsByClassName("User_Num")[0].innerHTML =
        `<img class="icon" src="/src/assets/icons/phone.svg" alt="icon not found"> ${inputData.contact.phone}`;
    ...
    inputData.languages.forEach(language => {
        ...
        languageElement.innerHTML = `<img class="icon" src="/src/assets/icons/tick.svg" alt="icon not found"> ${language}`;
